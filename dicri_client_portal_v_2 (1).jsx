...
const SegmentGeometryPanel = ({ segment, compact }) => (
  <div className={`bg-slate-950 rounded-[3.5rem] border border-white/5 relative overflow-hidden shadow-2xl ${compact ? 'p-7' : 'p-8'}`}>
    <div className="flex items-center justify-between mb-7">
      <h4 className="text-[10px] font-black text-slate-600 uppercase tracking-[0.5em]">Certified GIS Geometry</h4>
    ...
    <div className={`${compact ? 'h-52' : 'h-72'} rounded-[2.5rem] bg-[#020617] border border-white/5 relative overflow-hidden mb-7`}>
      <svg viewBox="0 0 600 260" className="absolute inset-0 w-full h-full">
        <defs>
          <linearGradient id="segmentGlow" x1="0" x2="1" y1="0" y2="0">
        ...
        {/* Faint street grid */}
        <path d="M20 58 H580" stroke="rgba(148,163,184,0.08)" strokeWidth="16" />
        <path d="M20 132 H580" stroke="rgba(148,163,184,0.07)" strokeWidth="14" />
        <path d="M20 206 H580" stroke="rgba(148,163,184,0.06)" strokeWidth="12" />
        <path d="M92 20 V240" stroke="rgba(148,163,184,0.06)" strokeWidth="14" />
        <path d="M248 20 V240" stroke="rgba(148,163,184,0.06)" strokeWidth="12" />
        <path d="M430 20 V240" stroke="rgba(148,163,184,0.06)" strokeWidth="14" />

        {/* Street labels */}
        <text x="36" y="48" fill="rgba(148,163,184,0.42)" fontSize="10" fontWeight="800" letterSpacing="2">ELEKAHIA ROAD</text>
        <text x="360" y="122" fill="rgba(148,163,184,0.35)" fontSize="9" fontWeight="800" letterSpacing="2">TRANS-AMADI LINK</text>
        <text x="104" y="232" fill="rgba(148,163,184,0.30)" fontSize="8" fontWeight="800" letterSpacing="2">HARCOURT AVE</text>
        <text x="440" y="36" fill="rgba(148,163,184,0.30)" fontSize="8" fontWeight="800" letterSpacing="2" transform="rotate(90 440 36)">WOJI ROAD</text>

        {/* Governance buffer */}
        <path d="M60 170 C160 70, 260 90, 350 135 S500 190, 545 80" fill="none" stroke="rgba(59,130,246,0.16)" strokeWidth="36" strokeLinecap="round" />
        <path d="M60 170 C160 70, 260 90, 350 135 S500 190, 545 80" fill="none" stroke="url(#segmentGlow)" strokeWidth="8" strokeLinecap="round" />
        ...
        {/* Start / end nodes */}
        <circle cx="60" cy="170" r="12" fill="rgba(34,197,94,0.12)" stroke="#22C55E" strokeWidth="2" />
        <circle cx="545" cy="80" r="12" fill="rgba(59,130,246,0.12)" stroke="#60A5FA" strokeWidth="2" />
        <text x="42" y="195" fill="#94A3B8" fontSize="9" fontWeight="900" letterSpacing="1.5">START</text>
        <text x="528" y="62" fill="#94A3B8" fontSize="9" fontWeight="900" letterSpacing="1.5">END</text>

        {/* High-risk buffer shown only when applicable */}
        {segment.risk === 'High' && <circle cx="405" cy="165" r="58" fill="#EF4444" fillOpacity="0.07" stroke="#EF4444" strokeWidth="2" strokeDasharray="8 8" />}
      </svg>
      <div className="absolute left-6 top-6 px-4 py-2 bg-slate-950/80 border border-white/10 rounded-xl text-[9px] font-black uppercase tracking-widest text-slate-400 backdrop-blur-md">
        {segment.location} / {segment.corridor}
      </div>
...
const CorridorMap = () => (
  <div className="h-[550px] bg-[#020617] rounded-[3rem] border border-white/5 relative overflow-hidden shadow-inner">
    <svg viewBox="0 0 800 500" className="absolute inset-0 w-full h-full">
      ...
      {/* Base GIS grid */}
      {[100, 200, 300, 400].map(y => <line key={y} x1="0" y1={y} x2="800" y2={y} stroke="rgba(255,255,255,0.035)" strokeWidth="1" />)}
      {[150, 350, 550, 750].map(x => <line key={x} x1={x} y1="0" x2={x} y2="500" stroke="rgba(255,255,255,0.035)" strokeWidth="1" />)}

      {/* Road corridors */}
      <path d="M100,0 L100,500" stroke="rgba(148,163,184,0.10)" strokeWidth="44" />
      <path d="M0,250 L800,250" stroke="rgba(148,163,184,0.11)" strokeWidth="42" />
      <path d="M0,360 C180,310 320,330 480,380 S680,430 800,390" stroke="rgba(148,163,184,0.055)" strokeWidth="24" fill="none" />
      <path d="M600,0 C570,120 585,260 640,500" stroke="rgba(148,163,184,0.055)" strokeWidth="20" fill="none" />

      {/* Street names */}
      <text x="28" y="235" fill="rgba(148,163,184,0.46)" fontSize="11" fontWeight="900" letterSpacing="2.5">TRANS-AMADI INDUSTRIAL ROAD</text>
      <text x="115" y="72" fill="rgba(148,163,184,0.40)" fontSize="10" fontWeight="900" letterSpacing="2.2" transform="rotate(90 115 72)">ELEKAHIA ROAD</text>
      <text x="470" y="365" fill="rgba(148,163,184,0.28)" fontSize="9" fontWeight="900" letterSpacing="2">ABA ROAD SPUR</text>
      <text x="616" y="95" fill="rgba(148,163,184,0.25)" fontSize="8" fontWeight="900" letterSpacing="2" transform="rotate(75 616 95)">WOJI LINK</text>

      {/* DICRI verified asset corridor */}
      <path d="M40,250 L760,250" stroke="rgba(34,197,94,0.14)" strokeWidth="30" strokeLinecap="round" />
      <path d="M40,250 L760,250" stroke="#22C55E" strokeWidth="12" strokeLinecap="round" strokeOpacity="0.72" />

      {/* Registered crossing utility */}
      <path d="M100,50 L100,450" stroke="rgba(59,130,246,0.18)" strokeWidth="26" strokeLinecap="round" />
      <path d="M100,50 L100,450" stroke="#3B82F6" strokeWidth="12" strokeLinecap="round" strokeOpacity="0.62" />

      {/* Municipal permit / conflict zone */}
      <circle cx="450" cy="250" r="100" fill="#EF4444" fillOpacity="0.055" stroke="#EF4444" strokeWidth="2" strokeDasharray="8,8" />
      <text x="478" y="155" fill="#FCA5A5" fontSize="9" fontWeight="900" letterSpacing="2">25M CONFLICT BUFFER</text>
      <text x="474" y="278" fill="#FCA5A5" fontSize="9" fontWeight="900" letterSpacing="2">CBYD-2026-00128</text>

      {/* Notice pins */}
      <circle cx="450" cy="250" r="12" fill="#EF4444" className="animate-ping opacity-20" />
      <circle cx="450" cy="250" r="6" fill="#EF4444" stroke="white" strokeWidth="2" />
      <circle cx="610" cy="345" r="18" fill="#EF4444" fillOpacity="0.16" stroke="#EF4444" strokeOpacity="0.3" />

      {/* Start / end nodes */}
      <circle cx="40" cy="250" r="7" fill="#22C55E" stroke="#020617" strokeWidth="3" />
      <circle cx="760" cy="250" r="7" fill="#22C55E" stroke="#020617" strokeWidth="3" />
      <text x="32" y="276" fill="#94A3B8" fontSize="8" fontWeight="900" letterSpacing="1.5">PH-TRA-B04</text>
      <text x="704" y="276" fill="#94A3B8" fontSize="8" fontWeight="900" letterSpacing="1.5">PH-TRA-B17</text>
    </svg>

    <div className="absolute top-10 left-10 space-y-3">
      <div className="bg-slate-900/90 backdrop-blur-xl p-6 rounded-3xl border border-white/10 shadow-3xl max-w-xs">
        <div className="flex items-center gap-3 mb-4"><MapIcon size={24} className="text-blue-500" /><span className="text-[10px] font-black uppercase text-white tracking-widest leading-none">Corridor Active</span></div>
        <p className="text-[9px] text-slate-400 font-bold uppercase tracking-widest leading-relaxed">Monitoring <span className="text-blue-400">Trans-Amadi Industrial Road</span> and <span className="text-green-400">DICRI verified fiber</span> against municipal dig permits.</p>
      </div>
    </div>

    <div className="absolute bottom-8 left-10 bg-slate-900/85 backdrop-blur-xl border border-white/10 rounded-2xl p-4 flex gap-5 text-[9px] font-black uppercase tracking-widest text-slate-400">
      <div className="flex items-center gap-2"><span className="h-2 w-5 rounded-full bg-green-500" /> Verified DICRI Asset</div>
      <div className="flex items-center gap-2"><span className="h-2 w-5 rounded-full bg-blue-500" /> Registered Crossing Utility</div>
      <div className="flex items-center gap-2"><span className="h-2 w-5 rounded-full bg-red-500" /> Municipal Dig Notice</div>
    </div>
